const NewConversation = () => {
  return (
    <div className="flex flex-nowrap justify-center items-center p-5 hover:bg-gray-700 cursor-pointer">
        ...
        <p className="text-xl ml-2 font-semibold">New Conversation</p>
    </div>
  )
}
